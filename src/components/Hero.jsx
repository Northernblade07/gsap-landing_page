...
const Hero = () => {
    ...
    useGSAP(()=>{
        ...
        const paragaphSplit = new SplitText(".subtitle", {
            type: "lines",
        })
...
<div className='body'>
    ...
    <div className='video absolute inset-0'>
        <video ref={videoRef} playsInline preload='auto' muted className='w-full h-full object-cover'>
