        ...
        <div className='mb-16 md:px-0 px-5'>
            <div className='content'>
                ...
                <div className='sub-content'>
                    <p>Every cocktail we server is a reflection of our obsession with detail - from the first muddle to the final garnish . That core is what turns a simple drink into something truly memorable</p>
